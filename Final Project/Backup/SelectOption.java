...
public class SelectOption extends JFrame{
	...
	public SelectOption(String UserName, int level) {
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				panel.removeAll();
				auctionProcess v = new auctionProcess();
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				panel.removeAll();
				SellerProcess v = new SellerProcess();
				panel.add(v.sellerTabbedPane());
				panel.revalidate();
				panel.repaint();
			}
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				panel.removeAll();
				BuyerProcess b = new BuyerProcess();
		...
		btnNewButton_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				panel.removeAll();
				AuctioneerProcess a = new AuctioneerProcess();
		...
		btnNewButton_6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				panel.removeAll();
				ReportProcess a = new ReportProcess();
