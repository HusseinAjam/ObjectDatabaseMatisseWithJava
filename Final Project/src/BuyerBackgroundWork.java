...
public class BuyerBackgroundWork extends JPanel implements ActionListener {
	 ...
	 public JTabbedPane buyerTabbedPane(){
		 ...
		 ComissionBidBackgroundWork comission = new ComissionBidBackgroundWork();
		 ...
		 UpdateBuyerPanel updateBuyer = new UpdateBuyerPanel();
